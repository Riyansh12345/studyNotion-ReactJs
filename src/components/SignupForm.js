...
const SignupForm = ({setIsLoggedIn}) => {
  ...
  return (
    <div>
        ...
        <div
        className='flex bg-richblack-800 p-1 gap-x-1 my-5 rounded-full max-w-max'
        >
            ...
            <div className='flex gap-4 mt-[20px]' >
                <label className='w-full relative'>
                    ...
                    onClick={() => setShowPassword((prev) => !prev)}>
                        ...
                        (<AiOutlineEyeInvisible fontSize={24} fill='#AFB28F'/>) : 

                        (<AiOutlineEye fontSize={24} fill='#AFB28F'/>)}
                    </span>
                </label>
